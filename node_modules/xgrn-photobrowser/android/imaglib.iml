...
<module external.linked.project.id=":imaglib" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/.." external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":imaglib" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="com.github.bumptech.glide:gifdecoder:4.0.0-RC1@jar" level="project" />
    ...
    <orderEntry type="library" name="com.github.bumptech.glide:annotations:4.0.0-RC1@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="com.android.support:support-annotations:25.4.0@jar" level="project" />
    ...
    <orderEntry type="library" name="jp.wasabeef:glide-transformations-2.0.2" level="project" />
    ...
    <orderEntry type="library" name="com.github.bumptech.glide:glide:4.0.0-RC1@jar" level="project" />
    <orderEntry type="library" name="com.facebook.react:react-native-0.55.3" level="project" />
    <orderEntry type="library" name="com.github.bumptech.glide:disklrucache:4.0.0-RC1@jar" level="project" />
    <orderEntry type="library" name="com.google.code.gson:gson:2.6.1@jar" level="project" />
