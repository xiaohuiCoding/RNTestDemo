...
@interface XGRNTabBarController : UITabBarController

/*
 *          .tabConfigs        Tab配置（当且仅当pageType===NativeTabPage）
 *             .isJS               bool true js调用 false native调用
 ...
 */
@property (nonatomic,strong)NSDictionary * tabConfigs;
