...
public class ReactFragment extends ReactDelegate {
    ...
    public Object setLayout() {
        ...
        mReactRootView = new ReactRootView(fragmentActivity);
        mReactInstanceManager = ((NavigationApplication)fragmentActivity.getApplication()).getReactNativeHost().getReactInstanceManager();
