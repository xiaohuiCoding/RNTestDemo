//
//  UINavigationController+XGRoute.h
//  XGNavigation
//
...
typedef NS_OPTIONS(NSUInteger, XGAlertLevel) {
    XGPageLevel = 0,
    XGNavigationLevel = 1 ,
    XGWindowLevel = 2,
};

@interface UINavigationController (XGRoute)

@property (nonatomic,readonly) NSArray * routeStack;//路由栈信息
